    ...
    static createReview(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const newSumOfRatings = (product === null || product === void 0 ? void 0 : product.sumOfRatings) + rating;
                const newNumberOfReviews = ((product === null || product === void 0 ? void 0 : product.numberOfReviews) || 0) + 1;
                const updatedProduct = yield Product_1.default.findByIdAndUpdate({
                    _id: productId
                }, {
